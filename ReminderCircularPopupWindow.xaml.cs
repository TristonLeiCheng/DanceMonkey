...
public partial class ReminderCircularPopupWindow : Window
{
    ...
    public ReminderCircularPopupWindow(ReminderDefinition reminder, ScheduledReminderService service)
    {
        _reminder = reminder;
        _service = service;
        ...
        ReminderPopupHost.PlayFadeIn(this, 320);
    }
